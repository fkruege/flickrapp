...
public interface FlickrRestApi {
    ...
    @GET("?method=flickr.photos.search&format=json&nojsoncallback=1&safe_search=1&is_getty=1&api_key=" + API_KEY + "&per_page=" + PAGE_SIZE)
    Single<PhotoResults> searchPhotosByTag(@Query("tags") String tag, @Query("page") int pageNo);
